...
.sym-formal-metrics .trust i { background:#8fb4ff; }.sym-formal-metrics .risk i { background:#d85762; }.sym-formal-metrics .friction i { background:#1e4fa3; }.sym-formal-metrics .latency i { background:#2f80ed; }
.sym-formal-clash-note { display:inline-flex; align-items:center; gap:.32rem; margin:-.12rem 0 .52rem; padding:.28rem .44rem; border:1px solid rgba(224,162,58,.28); border-radius:999px; color:#9a651b; background:rgba(255,248,232,.78); font-size:.56rem; font-weight:820; letter-spacing:.045em; text-transform:uppercase; }.sym-formal-clash-note i { width:6px; height:6px; border-radius:50%; background:#e0a23a; box-shadow:0 0 0 3px rgba(224,162,58,.12); animation:sym-clash-pulse 1.7s ease-in-out infinite; }.sym-formal-clash-note.quiet { color:#6d8498; border-color:rgba(96,124,147,.16); background:rgba(247,250,252,.72); }.sym-formal-clash-note.quiet i { background:#91a7b7; box-shadow:none; animation:none; }
...
.sym-formal-load { fill:url(#sym-formal-load); }.sym-formal-line { fill:none; stroke-width:2.35; stroke-linecap:round; stroke-linejoin:round; }.sym-formal-line.trust,.sym-formal-dot.trust { stroke:#8fb4ff; fill:#8fb4ff; }.sym-formal-line.risk,.sym-formal-dot.risk { stroke:#d85762; fill:#d85762; }.sym-formal-line.friction,.sym-formal-dot.friction { stroke:#1e4fa3; fill:#1e4fa3; }
.sym-formal-dot { stroke:#fff; stroke-width:1.8px; filter:drop-shadow(0 1px 2px rgba(47,128,237,.3)); }
.sym-formal-clash-line { stroke:rgba(224,162,58,.35); stroke-width:1; stroke-dasharray:3 4; }.sym-formal-clash-dot { fill:#fff8e8; stroke:#e0a23a; stroke-width:2px; filter:drop-shadow(0 1px 3px rgba(224,162,58,.36)); animation:sym-clash-pulse 1.7s ease-in-out infinite; transform-origin:center; }.sym-formal-clash-dot:hover { fill:#e0a23a; }
.sym-formal-legend { position:absolute; right:.5rem; bottom:.42rem; display:flex; gap:.38rem; padding:.3rem .4rem; border:1px solid rgba(47,128,237,.12); border-radius:8px; background:rgba(255,255,255,.8); color:#668197; font-size:.52rem; font-weight:800; letter-spacing:.05em; text-transform:uppercase; }.sym-formal-legend span:before { content:""; display:inline-block; width:5px; height:5px; margin-right:3px; border-radius:50%; background:#2f80ed; }.sym-formal-legend .trust:before { background:#8fb4ff; }.sym-formal-legend .risk:before { background:#d85762; }.sym-formal-legend .friction:before { background:#1e4fa3; }.sym-formal-legend .load:before { background:#48b8e8; }
...
@keyframes sym-clash-pulse { 0%,100% { opacity:.65; transform:scale(.82); } 50% { opacity:1; transform:scale(1.18); } }
